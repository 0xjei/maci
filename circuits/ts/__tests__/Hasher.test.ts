...
import { getSignal, circomkit } from "./utils/utils";
...
describe("Poseidon hash circuits", function test() {
  ...
  describe("SHA256", () => {
    describe("Sha256HashLeftRight", () => {
      ...
      before(async () => {
        circuit = await circomkit.WitnessTester("sha256HashLeftRight", {
          file: "hasherSha256",
    ...
    describe("Sha256Hasher4", () => {
      ...
      before(async () => {
        circuit = await circomkit.WitnessTester("sha256Hasher4", {
          file: "hasherSha256",
    ...
    describe("Sha256Hasher6", () => {
      ...
      before(async () => {
        circuit = await circomkit.WitnessTester("sha256Hasher6", {
          file: "hasherSha256",
  ...
  describe("Poseidon", () => {
    describe("Hasher5", () => {
      ...
      before(async () => {
        circuit = await circomkit.WitnessTester("hasher5", {
          file: "hasherPoseidon",
          template: "Hasher5",
        });
      });
    ...
    describe("Hasher4", () => {
      ...
      before(async () => {
        circuit = await circomkit.WitnessTester("hasher4", {
          file: "hasherPoseidon",
          template: "Hasher4",
        });
      });
    ...
    describe("Hasher3", () => {
      ...
      before(async () => {
        circuit = await circomkit.WitnessTester("hasher3", {
          file: "hasherPoseidon",
          template: "Hasher3",
        });
      });
    ...
    describe("Hasher13", () => {
      ...
      before(async () => {
        circuit = await circomkit.WitnessTester("hasher13", {
          file: "hasherPoseidon",
          template: "Hasher13",
        });
      });
    ...
    describe("HashLeftRight", () => {
      ...
      before(async () => {
        circuit = await circomkit.WitnessTester("hashLeftRight", {
          file: "hasherPoseidon",
  ...
  describe("MessageHasher", () => {
    ...
    before(async () => {
      circuit = await circomkit.WitnessTester("messageHasher", {
        file: "messageHasher",
